...
int main()
{
    SET Set_A,Set_B,inter,uni,diff;
    int k;
    char c,choice;
    ...
    do
    {
        ...
        switch(choice)
        {
            ...
            case '2':
             ...
             case '8':
                    cout<<endl<<"~ You Have Exited Successfully !!! ~"<<endl;
                    break;

             default: cout<<endl<<"~~~ Invalid Input,Enter The Correct Input!!! ~~~"<<endl<<endl;
